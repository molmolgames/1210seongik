...
{
    public Rigidbody2D En; // 적
    public SpriteRenderer SR; // 스프라이트렌더러
    public BoxCollider2D BC;
    public Animator animation; //애니메이션
    public PlayerMoving player; //플레이어
    public CapsuleCollider2D CC; //캡슐콜라이더
    public int h; // 이동 방향
    public float speed; // 이동 속도
    public float EnemyHP; // 적 총 체력
    public float EnemyCurrentHp; //적 현재 체력
    ...
    public void DropItem(int droppercent) //아이템드랍함수
    {
